<article id="post_{{$post->id}}" x-data="{open: true}" x-show="open"
    class="lg:col-span-6 transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
