<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 lg:flex justify-around align-center lmt-8 mt-12">
        ...
        <div class="h-auto absolute relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            <x-dropdown>
                <x-slot name="trigger">
                    <button class="z-10 w-full flex justify-around text-sm text-left
                    font-semibold" value="Category">
                        @if(isset($currentCategory)) {{$currentCategory->name}}
                        @else Category
                        @endif
                        <svg class="flex-end transform -rotate-90 pointer-events-none" style="right: 12px;" width="22"
